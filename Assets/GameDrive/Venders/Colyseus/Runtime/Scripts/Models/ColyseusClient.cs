...
namespace Colyseus
{
    ...
    public class ColyseusClient
    {
        ...
        public async Task<T[]> GetAvailableRooms<T>(string roomName = "", Dictionary<string, string> headers = null)
        {
            ...
            string json =
                await colyseusRequest.Request("GET", $"{_colyseusSettings.colyseusSubPath}/matchmake/{roomName}", null,
            ...
            Dictionary<string, string> headers = null)
        {
            ...
            room.SetConnection(CreateConnection(_colyseusSettings.colyseusSubPath + "/" + response.room.processId + "/" + room.Id, queryString, headers));
            ...
            void OnError(int code, string message)
            {
                ...
                tcs.SetException(new Exception(code + " : " + message));
            }
...
#pragma warning restore 4014
            ...
            Dictionary<string, object> options, Dictionary<string, string> headers)
        {
            ...
            string json = await colyseusRequest.Request("POST", $"{_colyseusSettings.colyseusSubPath}/matchmake/{method}/{roomName}", options, headers);
